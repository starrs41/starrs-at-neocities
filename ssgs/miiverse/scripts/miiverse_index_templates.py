...
<head>
  ...
  <link rel="stylesheet" href="misc/styles/miiverse-index.css">
</head>
<body class="u-pause-animation">
  <div class="o-navbar u-pause-animation">
    <div class="o-navbar__left">
      <a class="o-button--icon" href="../">
        <img src="../../graphics/misc/miiverse/home.svg" alt="Home Icon"><span>Back to Main Website</span>
      </a>
    </div>
    <div class="o-navbar__right">
      <label for="musicToggle" class="o-button o-button--checkbox">
          <input type="checkbox" id="musicToggle" data-music-id="index" /><span id="musicToggleText">Music: OFF</span>
      </label>
  ...
  <audio id="js-bgm">
    <source src="https://file.garden/akJr1M5SUwY64beP/TLLD%20-%20Title%2C%20Part%201.mp3" type="audio/mpeg">
    <span>Your browser does not support the audio element.</span>
  </audio>
  <audio loop id="js-bgm">
    <source src="https://file.garden/akJr1M5SUwY64beP/TLLD%20-%20Title%2C%20Part%202.mp3" type="audio/mpeg">
    <span>Your browser does not support the audio element.</span>
  </audio>
